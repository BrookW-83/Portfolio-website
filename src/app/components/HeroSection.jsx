      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#2f2f2f] text-base sm:text-lg mb-6 lg:text-xl font-serif font-semibold">
            As a front-end web developer, I've gained practical experience
            through internships and projects while being an A2SV student. A2SV
            has played a crucial role in shaping my skills and knowledge in web
            development. With expertise in HTML, CSS, and JavaScript, I focus on
            creating visually appealing and user-friendly interfaces. The
            comprehensive program at A2SV has equipped me with a solid
            understanding of web development concepts and best practices.
            Overall, I bring knowledge, passion, and practical experience to
            every project as a dedicated software developer.
          </p>
          <div>
            <Link
              href="/contact"
